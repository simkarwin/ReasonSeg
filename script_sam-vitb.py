...
def evaluate(model: ReasoningSegmentationModel, loader, device, save_vis_dir=None):
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(loader):
            ...
            iou = mean_iou(pred_mask.float(), mask.float())
...
def mean_iou(pred, target, num_classes=10):
    ious = []
...
# DATASET PATHS
# ============================================================
main_directory = "/media/volume/ReasonSeg/FloodNet/FloodNet-Supervised_v1.0"
...
model_type = "vit_b"
sam_checkpoint = "/media/volume/ReasonSeg/ViT-models/sam_vit_b_01ec64.pth"
